...
<a href="index.php"><img id="girls" src="images/shopgirls.gif" /></a>
<img id="mahira" src="images/mahira.jpg"/>
...
<div class="main_content">
	...
	<b style="color:yellow">Shopping Cart -</b> Total Items :  <?php total_items(); ?> Total Prize : <?php total_price(); ?> <a href="cart.php" style="color:yellow">GoTo Cart</a>
